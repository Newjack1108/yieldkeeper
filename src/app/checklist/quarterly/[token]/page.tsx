...
function QuarterlyChecklistForm() {
  ...
  useEffect(() => {
    if (!token) return;
    fetch(`/api/checklist/quarterly/${token}`)
      .then((res) => {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const res = await fetch(`/api/checklist/quarterly/${token}`, {
        method: "POST",
      ...
      <div className="flex min-h-screen flex-col items-center justify-center p-4">
        <Card className="w-full max-w-md">
          <CardHeader>
            ...
            <CardDescription>
              Your quarterly property check has been submitted. Your landlord has
              been notified.
            </CardDescription>
          </CardHeader>
          <CardContent>
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center p-4">
      <Card className="w-full max-w-lg">
        <CardHeader>
          <CardTitle>Quarterly property check</CardTitle>
          <CardDescription>
            Please confirm the condition of your property at {data?.propertyAddress}.
            This is a quick yes/no checklist to ensure everything is in good order.
          </CardDescription>
        </CardHeader>
        <CardContent>
